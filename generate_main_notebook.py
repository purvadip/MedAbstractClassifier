"""
generate_main_notebook.py
Generates medical_classification.ipynb in the current directory.
Run with: python generate_main_notebook.py
"""
import json
import os
...
cells = [
    ...
    md(["## Section 0: Configuration and Imports\n"]),
    code([
        "import pandas as pd\n",
        "import numpy as np\n",
    ...
    md([
        ...
        "> **Research Question:** Can machine learning models trained on weakly-supervised "
        "medical abstracts reliably classify them by research type (Diagnosis, Treatment, "
        "Prevention), and which textual features emerge as the strongest interpretable predictors?\n",
    ]),

    md(["## Section 2: Data Loading and Preprocessing\n"]),
    code([
        "import sys\n",
        "sys.path.insert(0, '.')\n",
    ...
    md(["## Section 3: Class Distribution Visualisation\n"]),
    code([
    ...
    md(["## Section 4: Exploratory Visualisations\n"]),
    code([
    ...
    md(["## Section 6: Model 1 — Logistic Regression (C = 10.0)\n"]),
    code([
    ...
    md(["## Section 7: Model 2 — Multinomial Naive Bayes (alpha = 0.05)\n"]),
    code([
    ...
    md(["## Section 8: Feature Interpretability (Logistic Regression)\n"]),
    code([
        "import numpy as np\n",
        "\n",
    ...
    md(["## Section 9: Model Comparison Table\n"]),
    code([
        "biobert = {\n",
...
out_path = os.path.join(os.path.dirname(__file__), "medical_classification.ipynb")
